...
class ConfigType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add(
            ...
            [
                'choices' => [
                    'eu-west-1' => 'mautic.email.config.mailer.amazon_host_api.eu_west_1',
                    'us-east-1' => 'mautic.email.config.mailer.amazon_host_api.us_east_1',
                    'us-west-2' => 'mautic.email.config.mailer.amazon_host_api.us_west_2',
                ],
